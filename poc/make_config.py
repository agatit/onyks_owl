...
def init_tracker_bars():
    ...
    cv2.createTrackbar("K1", WINDOW_NAME, 100000, 200000, nothing)
    cv2.createTrackbar("K2", WINDOW_NAME, 100000, 200000, nothing)
    cv2.createTrackbar("K3", WINDOW_NAME, 100000, 200000, nothing)
    cv2.createTrackbar("P1", WINDOW_NAME, 100000, 200000, nothing)
    cv2.createTrackbar("P2", WINDOW_NAME, 100000, 200000, nothing)
...
def get_config():
    ...
    k1 = (cv2.getTrackbarPos("K1", WINDOW_NAME) - 100000) / 100000
    k2 = (cv2.getTrackbarPos("K2", WINDOW_NAME) - 100000) / 100000
    k3 = (cv2.getTrackbarPos("K3", WINDOW_NAME) - 100000) / 100000
    p1 = (cv2.getTrackbarPos("P1", WINDOW_NAME) - 100000) / 100000
    p2 = (cv2.getTrackbarPos("P2", WINDOW_NAME) - 100000) / 100000
    config['dist'] = [k1, k2, p1, p2, k3]
