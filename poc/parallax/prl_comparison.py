...
out_out = cv2.VideoWriter(out_name, out_fourcc, out_framerate, (resizeSize[0] * 2, resizeSize[1] * 2))
...
def concImages(imgL, imgR, dispV1, dispV3):
    ###########################
    #            #            #
    #    imgL    #    imgR    #
    #            #            #
    ...
    down = np.concatenate((dispV1, dispV3), axis = 1)
...
while ret:
    ...
    conc = concImages(imgL, imgR, dispV2, dispV3)
