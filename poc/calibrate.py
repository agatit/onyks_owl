...
#camera = cv2.VideoCapture("rtsp://admin:Kartofel_1410@192.168.1.44:554")
camera = cv2.VideoCapture(0)
camera_matrix, distortion_coefficients  = live_calibrate(camera, (7,10), 10)
print(camera_matrix, distortion_coefficients)