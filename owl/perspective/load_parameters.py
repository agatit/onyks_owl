...
calibration_outputs_dir = '../../output_images'

# Filename used to save the camera calibration result (mtx,dist)
calibration_mtx_dist_filename = 'camera_cal_dist_cache.json'
...
def load_camera_mtx_dist_from_json():
    dist_json = json.load(open(join(calibration_outputs_dir, calibration_mtx_dist_filename), "rb"))
